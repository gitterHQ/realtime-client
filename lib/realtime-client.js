...
SnapshotExtension.prototype = {
  outgoing: function(message, callback) {
    ...
    if (genericListeners) {
      genericListeners.forEach(function(listener) {
        if(listener.getSnapshotStateForChannel) {
          var state = listener.getSnapshotStateForChannel(subscribeChannel);
          if (state) {
    ...
    var options = this.client.getSubscribeOptions(subscribeChannel);
    if (options) {
